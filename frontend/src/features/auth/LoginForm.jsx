                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        >
                            {isRegistration ? (
                                ...
                                <>
                                    <LogIn size={24} className="mr-2 text-gray-700" />
                                    Войти
                                </>
                            )}
                        </motion.h2>
                                ...
                                <>
                                    ...
                                    >
                                        <label className="flex items-center">
                                            ...
                                            <span className="ml-2 text-sm text-gray-700 dark:text-gray-700">Запомнить меня</span>
                                        </label>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        >
                                            {isLoading ? (
                                                ...
                                                <div className="flex items-center">
                                                    {isRegistration ? <UserPlus size={20} className="mr-2" /> : <LogIn size={20} className="mr-2" />}
